...
<main class="main-container">
  ...
  <section>
    ...
    <div class="prices">
      <div class="prices__list">
        <h3 class="prices__list-title">
          <span class="prices__item-desc">Article</span> <span class="prices__item-value">Tarif unitaire</span>
        </h3>
        <ul>
          <?php for ($i = 0; $i < count($extras); $i++) : ?>
            <li class="prices__item">
              <span class="prices__item-desc"><?= $extras[$i][0] . ' (' . $extras[$i][1] . ')'; ?></span> <span class="prices__item-value"><?= $extras[$i][2] ?> &euro;</span>
            </li>
          <?php endfor; ?>
        </ul>
      </div>
